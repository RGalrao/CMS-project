...
if($form){
  ...
  criar_nova_noticia($mostrar_na_home, $imagem, $titulo, $data, $texto);
  ...
  <main class="container-fluid">
    ...
    <div class="row">
      <div class="col-11 col-sm-10 m-auto mt-4 border border-4 border-secondary rounded-4 p-4">
        <h2>Criar Novo - Menu Noticias e Eventos</h2>
        <br>
        <form action="">
          ...
          <input type="submit" class="btn btn-primary" value="Criar Nova Noticia e/ou Evento">
        </form>
      </div>
    </div>

...
<footer>
  ...
  <div class="container-fluid desktop <?= ($menu_atual != "contactos") ? "pt-5 mt-5" : "" ?> "> <!-- FOOTER DESKTOP -->
    ...
    <?php if ($menu_atual != "contactos"): ?>
      ...
      <?php if ($menu_atual == "noticias"): ?>

        <div class="row pt-4 mt-3"> <!-- Texto DESTAQUES DESKTOP-->
          <div class="col-12 text-center titulo">
            Destaques
          </div>
        </div>

        <div class="row mt-5 pt-3"> <!-- Carousel DESTAQUES DESKTOP-->
                  ...
                  <div class="carousel-item <?= ($i == 0) ? "active" : "" ?>">
                    ...
                    <div class="carousel-caption text-start d-flex flex-column justify-content-between">
                      <div>
                        ...
                        <div class="texto"><?= abreviar($d["texto"], 700) ?></div>
                      </div>
                      <div>
                ...
                <div class="container-fluid">
                  <div class="row justify-content-end">
                    <div class="col-auto px-0 pai-buttons d-flex gap-2">
                      <?php foreach ($destaques as $i => $d): ?>
                        <button type="button" data-bs-target="#carousel-destaques-desktop" data-bs-slide-to="<?= $i ?>" class="<?= ($i == 0) ? "active" : "" ?>" aria-current="true" aria-label="Slide <?= $i + 1 ?>"></button>
                      <?php endforeach ?>
                    </div>
                  </div>
                </div>
